    ...
    render: function () {
        ...
        return (
            <div style={addrBlockStyle}>
                <div className="row">
                    <div className="col-md-2 label-align"><label
                        htmlFor="txtStreet">Street:</label> </div>
                ...
                <div className="row">
                    <div className="col-md-2 label-align"><label
                        htmlFor="txtCity">City:</label></div>
                    <div className="col-md-10">
                        <input type="text" id="txtCity" className="form-control"
                            style={{ width: "100%" }}
                            onChange={this.handlerChange}
                            value={this.props.address.city} /></div>
                </div>
                <div className="row">
                    <div className="col-md-2 label-align"><label
                        htmlFor="txtProvince">Province:</label> </div>
                    <div className="col-md-5">
                        <select type="text" id="drpProvince" className="formcontrol" style={{ width: "100%" }}
                            onChange={this.handlerChange}
                    ...
                    <div className="col-md-2 label-align"><label
                        htmlFor="txtPostalCode">Postal Code:</label></div>
                    <div className="col-md-3">
                        <input type="text" id="txtPostalCode" className="formcontrol" style={{ width: "100%" }}
                            onChange={this.handlerChange}
                            value={this.props.address.postalCode} /></div>
                </div>
            </div>
        );
    }
